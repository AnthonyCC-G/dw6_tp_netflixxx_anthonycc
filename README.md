...
Hachage des mots de passe : Utilisation de password_hash() / password_verify()
Protection contre les injections SQL : Requêtes préparées avec PDO
Protection XSS : htmlspecialchars() sur toutes les données utilisateur
...
bash   git clone https://github.com/[username]/dw6_tp_netflixxx_anthonycc.git
